...
?>
            ...
            <tr><td><?php echo $SLANG['ServerHost'] ?></td><td><input type="text" name="newMonitor[ServerHost]" value="<?php echo validHtmlStr($newMonitor['ServerHost']) ?>" size="16"/></td></tr>
...
?>
            ...
            <tr><td><?php echo $SLANG['RemoteHostJPGPath'] ?></td><td><input type="text" name="newMonitor[JPGPath]" value="<?php echo validHtmlStr($newMonitor['JPGPath']) ?>" size="36"/></td></tr>
            <tr><td><?php echo $SLANG['RemoteHostMJPGPath'] ?></td><td><input type="text" name="newMonitor[MJPGPath]" value="<?php echo validHtmlStr($newMonitor['MJPGPath']) ?>" size="36"/></td></tr>
<?php
        }
